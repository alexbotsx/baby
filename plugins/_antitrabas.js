...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51926490894-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': 'Bot baby', 'jpegThumbnail': null } } };
